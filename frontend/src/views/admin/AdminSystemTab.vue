    ...
    <div class="system-layout">
      <div class="card card--system-status">
        ...
        <div class="system-info-grid">
          ...
          <div class="info-item"><span class="info-label">Trạng thái kết nối CSDL:</span><span class="info-val text-success">Đang kết nối (PostgreSQL) <BaseIcon name="check" style="width:12px;height:12px" /></span></div>
...
const { BASE_URL, pushLog } = useAdminApi();
