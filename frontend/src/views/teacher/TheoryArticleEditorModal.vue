<template>
  <Transition name="modal-fade">
    ...
    <div v-if="show" ref="overlayEl" class="modal-overlay" role="dialog" aria-modal="true" aria-label="Tạo hoặc chỉnh sửa bài viết lý thuyết" @click.self="$emit('update:show', false)">
