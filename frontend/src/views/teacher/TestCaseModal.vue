...
const props = withDefaults(defineProps<Props>(), {
  title: 'Modal Testcase đang được tái cấu trúc',
  message:
    'Chức năng thêm/sửa testcase hiện chưa khả dụng. Khi hoàn tất tái cấu trúc, bạn có thể thêm/sửa testcase tại đây. Bấm "Lưu (Stub)" sẽ gửi lại dữ liệu hiện tại để flow không bị gãy.',
});
...
function onSaveStub() {
  ...
  emit('save', props.editingTestcase ?? {});
  close();
}
</script>
