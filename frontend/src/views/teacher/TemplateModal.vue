...
const props = withDefaults(defineProps<Props>(), {
  title: 'Modal Starter Template đang được tái cấu trúc',
  message:
    'Chức năng thêm/sửa starter template hiện chưa khả dụng. Khi hoàn tất tái cấu trúc, bạn có thể cấu hình template theo ngôn ngữ tại đây. Bấm "Lưu (Stub)" sẽ gửi lại dữ liệu hiện tại để flow không bị gãy.',
});
