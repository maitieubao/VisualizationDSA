    ...
    <div class="editor-toolbar">
      ...
      <div class="toolbar-group">
        ...
        <button 
          type="button" 
          class="toolbar-btn" 
          @click="insertTheoryArticle"
          title="ChÃ¨n bÃ i viáº¿t lÃ½ thuyáº¿t"
        >
          <BaseIcon name="book-open" class="w-4 h-4" />
        </button>
        <button 
          type="button" 
          class="toolbar-btn" 
          ...
          title="ChÃ¨n Quiz"
        >
          <BaseIcon name="help-circle" class="w-4 h-4" />
        </button>
        <button 
          type="button" 
          class="toolbar-btn" 
...
const emit = defineEmits<{
  ...
  (e: 'insert-theory-article'): void;
  (e: 'insert-quiz'): void;
  (e: 'insert-codelab'): void;
}>();
...
const placeholder = props.placeholder || 'Viáº¿t ná»™i dung bÃ i há»c báº±ng Markdown...';
...
function insertTheoryArticle() {
  // Emit event to parent to open TheoryArticlePickerModal
  emit('insert-theory-article');
}
