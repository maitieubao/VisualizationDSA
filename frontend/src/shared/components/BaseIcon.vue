<template>
  ...
  >
    ...
    <g v-else-if="name === 'dsa'">
      <path d="M12 2L2 7l10 5 10-5-10-5z" />
      <path d="M2 17l10 5 10-5" />
      <path d="M2 12l10 5 10-5" />
    </g>
    <g v-else-if="name === 'animation'">
    ...
    <g v-else-if="name === 'compare'">
      ...
      <path d="M6 7l-3 9h6l-3-9z" />
      <path d="M18 7l-3 9h6l-3-9z" />
    </g>
    <g v-else-if="name === 'concurrency'">
      <path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.57-8.38l5.67-5.67" />
    </g>
    <g v-else-if="name === 'debug'">
      <rect x="5" y="3" width="14" height="14" rx="2" />
      <line x1="12" y1="1" x2="12" y2="3" />
      <line x1="8" y1="8" x2="2" y2="8" />
      <line x1="16" y1="8" x2="22" y2="8" />
      <line x1="8" y1="12" x2="2" y2="14" />
      <line x1="16" y1="12" x2="22" y2="14" />
      <path d="M6 21c0-1.5 2-3 6-3s6 1.5 6 3" />
    </g>
    <g v-else-if="name === 'graph'">
    ...
    <g v-else-if="name === 'playground'">
      <polygon points="12 2 2 7 12 12 22 7 12 2" />
      <polyline points="2 17 12 22 22 17" />
      <polyline points="2 12 12 17 22 12" />
    </g>
    <g v-else-if="name === 'oop'">
      <rect x="3" y="3" width="7" height="7" />
      <rect x="14" y="3" width="7" height="7" />
      <rect x="14" y="14" width="7" height="7" />
      <rect x="3" y="14" width="7" height="7" />
    </g>
    <g v-else-if="name === 'solid'">
    ...
    <g v-else-if="name === 'patterns'">
      <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 14.7255 3.09032 17.1962 4.85857 19C5.03458 19.176 5.0924 19.4352 5.00693 19.6732C4.78913 20.2801 4.54228 20.8415 4.26909 21.3528C4.1068 21.6565 4.31682 22 4.66282 22H12Z" />
      <circle cx="7.5" cy="10.5" r="1.5" fill="currentColor" />
      <circle cx="11.5" cy="7.5" r="1.5" fill="currentColor" />
      <circle cx="16.5" cy="9.5" r="1.5" fill="currentColor" />
      <circle cx="15.5" cy="14.5" r="1.5" fill="currentColor" />
    </g>
    <g v-else-if="name === 'state'">
    ...
    <g v-else-if="name === 'quiz'">
      <circle cx="12" cy="12" r="10" />
      <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
      <line x1="12" y1="17" x2="12.01" y2="17" />
    </g>
    <g v-else-if="name === 'gamification' || name === 'leaderboard' || name === 'trophy'">
    ...
    <g v-else-if="name === 'checkout' || name === 'diamond'">
    ...
    <g v-else-if="name === 'streak' || name === 'streak-keeper'">
    ...
    <g v-else-if="name === 'bulb' || name === 'idea'">
    ...
    <g v-else-if="name === 'academic'">
      <path d="M22 10v6M2 10l10-5 10 5-10 5z" />
      <path d="M6 12v5c0 2 2 3 6 3s6-1 6-3v-5" />
    </g>
    <g v-else-if="name === 'teacher'">
    ...
    <g v-else-if="name === 'impersonate'">
      <path d="M12 2a10 10 0 0 0-10 10c0 5.523 4.477 10 10 10s10-4.477 10-10A10 10 0 0 0 12 2zm0 3a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm0 14.2a7.2 7.2 0 0 1-6-3.2c0-2 4-3.1 6-3.1s6 1.1 6 3.1a7.2 7.2 0 0 1-6 3.2z" />
    </g>
    <g v-else-if="name === 'shield'">
      <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
    </g>
    <g v-else-if="name === 'chart-bar'">
      <line x1="18" y1="20" x2="18" y2="10" />
      <line x1="12" y1="20" x2="12" y2="4" />
      <line x1="6" y1="20" x2="6" y2="14" />
    ...
    <g v-else-if="name === 'step-forward'">
      <polygon points="5 4 15 12 5 20 5 4" fill="currentColor" />
      <line x1="19" y1="5" x2="19" y2="19" />
    </g>
    <g v-else-if="name === 'step-backward'">
    ...
    <g v-else-if="name === 'sorting-wizard'">
      <polygon points="12 2 3 9 9 9 9 22 15 22 15 9 21 9 12 2" />
    </g>
    <g v-else-if="name === 'oop-guru'">
      <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
      <path d="M7 11V7a5 5 0 0 1 10 0v4" />
    </g>
    <g v-else-if="name === 'solid-master'">
      <path d="M4 22V4c0-.5.5-1 1-1h14c.5 0 1 .5 1 1v18M12 22V10" />
      <line x1="4" y1="10" x2="20" y2="10" />
      <line x1="4" y1="15" x2="20" y2="15" />
    </g>
    <g v-else-if="name === 'pattern-hunter'">
      <circle cx="11" cy="11" r="8" />
      <line x1="21" y1="21" x2="16.65" y2="16.65" />
      <circle cx="11" cy="11" r="3" fill="currentColor" />
    </g>
    <g v-else-if="name === 'system-architect'">
      <rect x="2" y="2" width="20" height="8" rx="2" />
      <rect x="2" y="14" width="20" height="8" rx="2" />
      <line x1="6" y1="10" x2="6" y2="14" />
      <line x1="18" y1="10" x2="18" y2="14" />
    </g>
    <g v-else-if="name === 'dsa-champion'">
    ...
    <g v-else-if="name === 'arrows-horizontal'">
      <path d="M8 3L4 7l4 4" />
      <path d="M4 7h16" />
    ...
    <g v-else-if="name === 'refresh-ccw'">
      <polyline points="1 4 1 10 7 10" />
      <polyline points="23 20 23 14 17 14" />
      <path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10" />
      <path d="M1 10l4.64 4.36A9 9 0 0 0 20.49 15" />
    </g>
    <g v-else-if="name === 'skip-forward'">
      <polygon points="3 4 11 12 3 20 3 4" fill="currentColor" />
      <polygon points="13 4 21 12 13 20 13 4" fill="currentColor" />
    </g>
    <g v-else-if="name === 'skip-backward'">
      <polygon points="21 4 13 12 21 20 21 4" fill="currentColor" />
      <polygon points="11 4 3 12 11 20 11 4" fill="currentColor" />
    </g>
    ...
    <g v-else-if="name === 'bold'">
      <path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z" />
      <path d="M6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z" />
    </g>
    <g v-else-if="name === 'italic'">
      <line x1="19" y1="4" x2="10" y2="4" />
      <line x1="14" y1="20" x2="5" y2="20" />
      <line x1="15" y1="4" x2="9" y2="20" />
    </g>
    <g v-else-if="name === 'strikethrough'">
    ...
    <g v-else-if="name === 'masks'">
      <path d="M17.5 2.5c-1.75 0-3.5.75-5.5 2.25-2-1.5-3.75-2.25-5.5-2.25C3.5 2.5 1 5.5 1 8.75c0 4.75 5 9.25 11 14 6-4.75 11-9.25 11-14 0-3.25-2.5-6.25-5.5-6.25Z" />
    ...
    <g v-else-if="name === 'tree'">
      <path d="M12 22v-7" />
      <path d="M12 15c-3 0-5.5-1.5-5.5-4.5 0-2 1.5-3.5 3.5-4 0-2 2-3.5 4-3.5s4 1.5 4 3.5c2 .5 3.5 2 3.5 4 0 3-2.5 4.5-5.5 4.5z" />
    </g>
    <g v-else-if="name === 'corner-up-left'">
      <polyline points="9 14 4 9 9 4" />
      <path d="M20 20v-7a4 4 0 0 0-4-4H4" />
    </g>

    
    <g v-else-if="name === 'bluesky-icon'">
      <path d="M6.335 0C4.591 0 3.327 1.565 3.327 3.63c0 1.191.577 2.46 1.4 3.63h.544V6.13c0-.83.673-1.504 1.503-1.504h.765c-.63.9-1.01 2.14-1.01 3.465 0 .77.151 1.469.437 2.059.643-2.93 2.633-5.282 5.284-6.46l-1.86-.743c-.237-.094-.48-.14-.729-.14h-.283a.38.38 0 0 1-.38-.38V2.02h.151c.528 0 1.056.114 1.53.336l1.264.59c.44.205.93.308 1.424.308.386 0 .773-.06 1.14-.18l-.001-.001c-.52-.5-.833-1.2-.833-1.973C13.225 1.565 11.962 0 10.217 0c-1.09 0-1.838.566-2.367 1.201C7.322.566 6.573 0 5.483 0h.852H6.335z" fill="currentColor" />
    </g>
    <g v-else-if="name === 'discord-icon'">
...
// CU-033: path bluesky/discord/github đã bổ sung theo chuẩn simple-icons (viewBox 24×24),
// vì vậy bỏ các viewBox special lệch (16×17, 20×19, 19×19) — tất cả icon dùng 0 0 24 24.
const viewBox = '0 0 24 24';

const className = computed(() => {
  return `base-icon ${props.class}`;
});
</script>
