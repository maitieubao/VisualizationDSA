...
const PAGE_TOURS: Record<string, TourStep[]> = {
  ...
  '/compare': [
    ...
    {
      title: '8. Khởi động chạy song hành',
      icon: 'play',
  ...
  '/concurrency': [
    ...
    {
      title: '3. Đường ray luồng (Thread Rails)',
      icon: 'learning-path',
    ...
    {
      title: '6. Bộ điều khiển VCR Playback',
      icon: 'timeline',
    ...
    {
      title: '7. Phát hoạt cảnh đa luồng',
      icon: 'play',
    ...
    {
      title: '9. Thanh trượt Timeline luồng',
      icon: 'timeline',
    ...
    {
      title: '10. Tùy chỉnh tốc độ thực thi',
      icon: 'timer',
    ...
    {
      title: '11. Phân tích Tranh chấp (Race Condition)',
      icon: 'warning',
    ...
    {
      title: '12. Xử lý Deadlock an toàn',
      icon: 'shield',
  ...
  '/oop': [
    ...
    {
      title: '5. Cấp phát đối tượng động',
      icon: 'cog',
    ...
    {
      title: '10. Kích hoạt hàm Đa hình',
      icon: 'play',
  ...
  '/solid': [
    {
      title: '1. Trực quan hóa Nguyên lý SOLID',
      icon: 'construction',
    ...
    {
      title: '7. Giải quyết vi phạm LSP',
      icon: 'tool',
    ...
    {
      title: '8. Nguyên lý Phân tách Giao diện (ISP)',
      icon: 'puzzle',
    ...
    {
      title: '11. So sánh Vi phạm vs Tuân thủ',
      icon: 'scales',
  ...
  '/state': [
    ...
    {
      title: '5. Cảnh báo Stack Overflow',
      icon: 'warning',
    ...
    {
      title: '9. Điều khiển timeline trạng thái',
      icon: 'timeline',
    ...
    {
      title: '10. Phân biệt truyền Tham chiếu vs Tham trị',
      icon: 'scales',
  ...
  '/code-ide': [
    ...
    {
      title: '5. Nút Step Over (Chạy qua từng dòng)',
      icon: 'step-forward',
    ...
    {
      title: '6. Nút Continue (Chạy tiếp)',
      icon: 'play',
  ...
  '/di': [
    ...
    {
      title: '5. Đồ thị Dependency Graph',
      icon: 'graph',
    ...
    {
      title: '7. Quy trình giải quyết phụ thuộc',
      icon: 'cog',
    ...
    {
      title: '11. Giải phóng dịch vụ đã dùng',
      icon: 'trash',
  ...
  '/patterns': [
    ...
    {
      title: '4. Thay đổi trạng thái Subject',
      icon: 'cog',
    ...
    {
      title: '7. Mô phỏng Strategy Pattern',
      icon: 'tool',
    ...
    {
      title: '10. Kiểm tra tương tác Dynamic',
      icon: 'graph',
    ...
    {
      title: '11. So sánh với lập trình không mẫu',
      icon: 'scales',
  ...
  '/system': [
    ...
    {
      title: '3. Cân bằng tải Load Balancer',
      icon: 'scales',
    ...
    {
      title: '6. Cơ sở dữ liệu Replication',
      icon: 'database',
