import { CONFETTI_COLORS, CONFETTI_PARTICLE_COUNT } from '@/features/gamification/gamification-engine/types/gamification.types';
import type { ConfettiParticle } from '@/features/gamification/gamification-engine/types/gamification.types';
