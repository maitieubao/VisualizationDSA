...
import { CONFETTI_DURATION_MS, MAX_STREAK_FREEZES, LEADERBOARD_TOP_N } from '@/features/gamification/gamification-engine/types/gamification.types';
import type { LeaderboardEntry, UserProgressState } from '@/features/gamification/gamification-engine/types/gamification.types';
