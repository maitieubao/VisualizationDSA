<template>
  <div class="rounded-2xl bg-bg-secondary/45 border border-border-default backdrop-blur-xl p-6">
...
import type { LeaderboardEntry } from '@/features/gamification/gamification-engine/types/gamification.types';
