...
import type { FireParticle } from '@/features/solid/solid-visualization/types/solid-visualization.types';
import { MAX_PARTICLES } from '@/features/solid/solid-visualization/types/solid-visualization.types';
