...
import type {
  ...
  DIPState,
} from '@/features/solid/solid-visualization/types/solid-visualization.types';
import {
  LSP_LASER_DELAY_MS,
  COOL_DOWN_CONFETTI_EVENT,
  GLASS_BREAK_SOUND_EVENT,
} from '@/features/solid/solid-visualization/types/solid-visualization.types';
import { executeSOLIDScenario, type SOLIDFrameResponse } from '@/features/solid/solid-visualization/services/solidApi';
import {
  SOLID_SCENARIOS,
  type SOLIDScenario,
