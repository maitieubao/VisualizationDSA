import type { LiveFrameDTO } from '@/features/core-learning/code-to-visualization/types/compiler.types';
import type { FrameDTO } from '@/features/core-learning/animation-engine/types/animation.types';
