<template>
  <div class="relative w-full h-full overflow-hidden">
    ...
    <div v-show="store.nodes.length > 0 || store.isAlgorithmMode || store.isGuideDismissed" class="absolute bottom-4 left-1/2 -translate-x-1/2 px-4 py-2.5 rounded-xl text-[11px] font-medium text-text-secondary bg-bg-secondary/80 backdrop-blur-md border border-border-default pointer-events-none transition-all shadow-2xl select-none text-center max-w-[90%] md:min-w-[340px] z-[1000]">
