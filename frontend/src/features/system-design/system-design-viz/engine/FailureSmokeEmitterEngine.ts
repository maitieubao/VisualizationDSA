import type { SmokeParticle } from '@/features/system-design/system-design-viz/types/system-design-viz.types';
import { SMOKE_BURST_COUNT, SMOKE_CONTINUOUS_PROBABILITY } from '@/features/system-design/system-design-viz/types/system-design-viz.types';
