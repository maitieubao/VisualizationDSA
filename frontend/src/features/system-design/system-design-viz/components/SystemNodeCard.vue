...
import type { SystemNode } from '@/features/system-design/system-design-viz/types/system-design-viz.types';
import { NODE_TYPE_LABELS } from '@/features/system-design/system-design-viz/types/system-design-viz.types';
