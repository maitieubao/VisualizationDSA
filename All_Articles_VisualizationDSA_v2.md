...
Biến mảng lộn xộn ban đầu thành một cấu trúc Max Heap. Sau khi xây xong, phần tử lớn nhất của toàn bộ mảng chắc chắn sẽ nằm ở **vị trí đầu tiên `array[0]`** (Gốc của cây).
