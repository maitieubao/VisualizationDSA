...
| [07](./07-courses-lessons.md) | Courses & Lessons (LMS) | 9/10 | Thực dụng | **A1-A3:** authoring + 7 codelab seed + E2E; **bug hidden-testcase đã fix** |
| [08](./08-lesson-study.md) | Lesson Study / Curriculum | 9/10 | Thực dụng | Codelab thật ở bước 4 |
| [09](./09-teacher-panel.md) | Teacher Panel | 8/10 | Thực dụng | **A1.4:** form soạn bài + preview-as-student |
| [10](./10-classrooms.md) | Classrooms | 8/10 | Thực dụng | **C2:** notification bài mới + deadline lớp |
| [11](./11-gamification.md) | Gamification | 8/10 | Thực dụng | **C2:** level-up/badge notify; **bug notify trước commit đã fix** |
| [12](./12-user-profile.md) | User Profile | 8/10 | Thực dụng | Không đổi |
| [13](./13-embed-widget.md) | Embed Widget | 5/10 | Demo-grade | **C3:** HOST_GUIDE + sample-host.html; **chưa verify LMS thật** |
| [14](./14-export-share.md) | Export & Share | 7/10 | Demo-grade | **C4:** chốt chiến lược hướng A + xuất PNG playground |
| [15](./15-notifications.md) | Notifications | 8/10 | Thực dụng | **C2:** 5 nguồn thật (reply/level-up/badge/bài mới/deadline) |
| [16](./16-core-ui.md) | Core & UI | 9/10 | Thực dụng | **D2:** i18n vi/en; **D3:** docs/components.md |

## Ưu tiên xác thực (theo rủi ro/giá trị)
