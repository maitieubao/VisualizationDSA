...
> **Ngày báo cáo:** 2026-08-14 · **Điểm giá trị thực tế hiện tại:** 9/10 🟢 Thực dụng (giữ nguyên)
...
| :-- | :-- | :-- |
| BaseIcon (1 nguồn icon SVG, không icon font/emoji rải rác) | `frontend/src/shared/components/BaseIcon.vue` | ✅ |
| Theory components (AccordionItem, CollapsiblePanel, SummaryView) | `shared/components/*` | ✅ |
| Theme store (dark/light, hết FOUC) | `shared/store/useThemeStore.ts` | ✅ |
| RenderMarkdown escape-first (không XSS) | `shared/utils/markdown.ts` | ✅ |
| apiClient tập trung (401 retry) | `shared/services/*` | ✅ |
| **D2: i18n sẵn sàng** — `useI18n()` (locale vi/en mặc định 'vi', `t()` nội suy {var}, persist localStorage) + áp dụng cho algo-playground | `frontend/src/shared/i18n/index.ts` | ✅ NEW |
| **D3: tài liệu component** | `docs/components.md` | ✅ NEW |
| Emoji parser (an toàn render emoji→SVG) | `shared/utils/emojiParser.ts` | ✅ |
